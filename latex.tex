...
\begin{table}[htb]
  ...
  \begin{tabular}{lp{6cm}}
    ...
    \verb+localhyphenation.sty+ & for words where the \latex hyphenation algorithm doe not produce the desired result      \\
...
This will give you  \tabref{tab:chapterhandle:keytotable}. There are ways to add additional vertical lines, but this should generally not be done. If your cells get to wide, use \verb+\begin{tabular}{p{4cm}p{4cm}p{4cm}}+, rather than \verb+\begin{tabular}{lll}+
\begin{table}[h]
  \begin{tabular}{lll}
    \lsptoprule
    German  & French  & Spanish \\
