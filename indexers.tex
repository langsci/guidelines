...
If there are two or more entries on subsequent pages, the index generation will automatically produce a range. So, instead of `33,34,35,36', it will print out `33--36'. You can produce ranges yourself by using \computer{{\bs}\{someterm|(\}} for the start and  \computer{{\bs}is\{someterm|)\}} for the end of the range. 
