...
Thiersch\aimention{Craig Thiersch}. The modified package is called \texttt{lsp-gb4e}. 
% % It is contained in the styles directory that is delivered with the \lsp \latex classes. It differs from the original package in loading a version of \texttt{gloss} that was modified by Alexis Dimitriadis\aimention{Alexis Dimitriadis} in order to be compatible with \texttt{jambox} (see Section~\ref{sec-jambox}).
...
\section{Trees: \texttt{tikz-qtree}}
