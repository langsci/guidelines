...
Furthermore, \computer{{\bs}langinfo} has to be adapted to reflect the correct language, family and source of the example, or removed altogether. 
...
%\includegraphics[width=3.3898in,height=3.4319in,width=\textwidth]{a8dc5773011814b3b98013db7af4ec7e9-img1.png}
