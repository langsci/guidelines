...
\item check for widows and orphans. If a paragraph is split between pages, there should be at least two lines on both pages. In order to move  an orphan to the following page, use \computer{{\bs}newpage} at the relevant position. In order to pull a widow back to the preceding page, use \computer{{\bs}enlargethispage\{1\baselineskip\}}. This will allow an extra line on this page. You can add more extra lines with \computer{2{\bs}baselineskip} and so on.  
\item check for split footnotes. Sometimes, long footnotes are split across pages. You can use \computer{{\bs}enlargethispage\{1\baselineskip\}} as above, or you can try to move the word with the footnote to another page. Sometimes, there are chain dependencies, which can be tough to resolve
