...
Glossed\is{glossing|(}\ispackage{lsp-gb4e} examples are typeset with a modified version of the \texttt{gb4e}\ispackage{gb4e} package by Craig
...
\glt `an interesting example'
\z 
\is{glossing|)}\ispackage{lsp-gb4e}
...
The\ispackage{jam\-box} package \texttt{jambox} by Alexis Dimitriadis\ia{Dimitriadis, Alexis} can be used to provide information about the language of an example or
