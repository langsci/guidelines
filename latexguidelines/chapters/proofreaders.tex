...
Proofreaders can choose their preferred way of working. \textsc{pdf} comments, scanned comments on printout, or lists of errors with page numbers are in principle all acceptable. In general, however, it is preferable that proofreaders work on the online annotation platform \url{www.paperhive.org}. 
...
\laundrybox{Proofreading list of references}{
